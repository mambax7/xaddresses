...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../uploads/xaddresses/files/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../uploads/xaddresses/files/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 1000 * 1024 ); //by bytes
