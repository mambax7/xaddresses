...
$modversion['release_date'] = '2011/10/11';
$modversion['release'] = strtotime('2011/10/11'); // 'YYYY/MM/DD' format
...
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'xaddresses_search.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'xaddresses_results.html';
$modversion['templates'][$i]['description'] = '';
