...
define("_FORMGOOGLEMAP_GO_CURRENT", "Marker");
define("_FORMGOOGLEMAP_GO_CURRENT_DESC", "Go to Actual Marker position");
...
define("_FORMGOOGLEMAP_LATLNGZOOM_DESC",
    "Move the Marker to automatically set the coordinates, set the coordinates to automatically move the map
    <br />
    <small>Use: deg-min-sec suffixed with N/S/E/W (e.g. 40&deg;44&#39;55&quot;N, 73 59 11W), 
    <br />
    or signed decimal degrees without compass direction, where negative indicates west/south (e.g. +40.689060  -74.044636)</small>");
