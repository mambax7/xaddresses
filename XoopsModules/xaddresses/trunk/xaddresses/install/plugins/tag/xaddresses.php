...
function xaddresses_tag_iteminfo(&$items)
{
    ...
    $item_handler =& xoops_getmodulehandler('Xaddresses_address', 'xaddresses');
    $items_obj = $item_handler->getObjects(new Criteria("loc_id", "(" . implode(", ", $items_id) . ")", "IN"), true);
...
{
    $item_handler =& xoops_getmodulehandler('Xaddresses_addresses', 'xaddresses');
