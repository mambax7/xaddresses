...
define("_XADDRESSES_AM_ABOUT_MODULEWEBSITE", "Support Website");
...
define("_XADDRESSES_AM_FIELD_NAME", "Name");
define("_XADDRESSES_AM_FIELD_NAME_DESC", "// IN PROGRESS");
...
define("_XADDRESSES_AM_FIELD_MAXLENGTH", "Maximum Length");
...
// admin/index.php
define("_XADDRESSES_AM_INDEX_INFO", "Statistic");

define("_XADDRESSES_AM_INDEX_LOCATIONS", "There are <b><span style='color : Red'> %s </span></b> Locations in our database");
define("_XADDRESSES_AM_INDEX_WAITING", "There are <b><span style='color : Red'> %s </span></b> Locations waiting for approval");
define("_XADDRESSES_AM_INDEX_BROKEN", "There are <b><span style='color : Red'> %s </span></b> broken Locations reports");
define("_XADDRESSES_AM_INDEX_MODIFIED", "There are <b><span style='color : Red'> %s </span></b> Location info modification requests");
...
define("_XADDRESSES_AM_REDIRECT_NOCAT", "You have to create a category");
