...
function directionsintroduction() {
    gob('help').innerHTML = 'Ready for Directions. Create a route along roads with markers at chosen locations.\n'
...
function markerintroduction() {
    gob('help').innerHTML = 'Ready for Marker. Click on the map, or enter an address and click "Search", to place a marker.\n'
...
function polylineintroduction() {
    gob('help').innerHTML = 'Ready for Polyline. Click on the map. The code for the shape you create will be presented here.\n\n'
...
function polygonintroduction() {
    gob('help').innerHTML = 'Ready for Polygon. Click on the map. The code for the shape you create will be presented here. '
...
function rectangleintroduction() {
    gob('help').innerHTML = 'Ready for Rectangle. Click two times on the map - first for the southwest and '+
...
function circleintroduction() {
    gob('help').innerHTML = 'Ready for Circle. Click for center. Then click for radius distance. '+
