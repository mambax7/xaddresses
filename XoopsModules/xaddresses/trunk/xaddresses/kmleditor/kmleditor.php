...
<div id = "content">
    <p>
        Click on the map. The code for the shape you create will be presented here.<br />
        You may shift from Polyline to Polygon and vice/versa at any time when you draw.<br />
        When finished with a shape, click 'Next shape' and draw another shape, if you wish.<br />
        If you want to draw polygon with hole(-s), choose Polygon and follow the instructions.<br />
        Polyline and polygon may be edited by clicking 'Edit lines'.<br />
        If you want to edit a saved polyline or polygon (including Rectangle), click on it. Then click 'Edit lines'.<br />
        There are style options for everything you draw on the map.<br />
        The complete KML code for what you have created, is always available with Show KML.<br />
        Uncheck 'Live code presentation' for greater speed when you draw shapes with large amount of points.<br />
        Check it when you want to see the code.
    </p>
    <p>
